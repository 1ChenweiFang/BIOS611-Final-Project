This is the final project for BIOS611. In this report, we used the public data that contained the cuisine and the inspection type in New York City. By using this data, we applied multiple datascience technique to investigate the trend of restaurant types, 
the restaurant type that violets code the most and severest. Finally, we applied the language the model for cuisine type prediction for the sake of future use.
